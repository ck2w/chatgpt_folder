...
## Goals
- Implement a folder tree in the left sidebar with expand/collapse, drag-and-drop reordering, and counts.
...
## UI behavior (MVP)
- Sidebar section titled "Folders" above the existing chat list.
